  ...
  return (
    <div
      className={`
        ...
        backdrop-blur-sm
      `}
      style={{ minWidth: 190, background: 'rgba(46,16,101,0.35)' }}
    >
      <div className="flex items-center gap-1.5 px-2.5 pt-1.5 pb-1 border-b border-violet-500/15"
        ...
        <span className="text-[9px] font-mono font-bold text-violet-400 tracking-widest uppercase">Service Account</span>
      </div>
